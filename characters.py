...
class Enemigo2(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, lista):
        super().__init__()
        self.image = mirror_img(pygame.transform.scale(pygame.image.load("files\characters\enemies\enemy2\idle.png"),(40, 80)))
        self.rect = self.image.get_rect()
        self.blood = 100
        self.rect.x = x
        self.rect.y = y
...
class Enemigo4(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, shot, level):
        ...
        self.image = mirror_img(
            pygame.transform.scale(pygame.image.load("files\characters\enemies\enemy4\Attack (4).png"), (60, 100)))
        self.imagel = mirror_img(
            pygame.transform.scale(pygame.image.load("files\characters\enemies\enemy4\Attack (4).png"), (60, 100)))
        self.imager = pygame.transform.scale(pygame.image.load("files\characters\enemies\enemy4\Attack (4).png"),
                                             (60, 100))
        self.rect = self.image.get_rect()
        self.blood = 50
        self.rect.x = x
    ...
    def disparar(self):
        ...
        sh = Enemy_shot(self.shot_dir, self.rect.x, self.rect.y + 20)
        sh.image = pygame.transform.scale(pygame.image.load("files\characters\enemies\enemy4\shot.png"),(40, 40))
        sh.tipo = "blast"
        sh.cambio_x = 10
        self.level.balas_lista.add(sh)
